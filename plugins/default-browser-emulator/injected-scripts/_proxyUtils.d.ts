...
declare function runAndInjectProxyInStack(target: any, thisArg: any, argArray: any, proxy: any): any;
...
declare const setProtoTracker: WeakSet<Error>;
declare function internalCreateFnProxy<T extends object>(opts: {
    target: T;
    descriptor?: any;
    custom?: ProxyHandler<T>;
    inner?: ProxyHandler<T> & {
        disableGetProxyOnFunction?: boolean;
    };
