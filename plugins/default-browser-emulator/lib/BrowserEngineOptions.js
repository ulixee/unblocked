        ...
        if (defaultBrowserId) {
            ...
            if (!this.default) {
                if (this.browserIdsNeedingDataFiles.has(id) || this.getInstalled(id)) {
                    throw new Error(`The Default Browser Engine specified in your environment does not have Emulation Data Files installed. You'll need to generate data files for ${id}`);
                }
