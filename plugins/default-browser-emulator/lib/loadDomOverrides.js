...
function loadDomOverrides(config, emulationProfile, data, userAgentData) {
    ...
    if (consoleConfig) {
        ...
        domOverrides.registerWorkerOverrides(IBrowserEmulatorConfig_1.InjectedScript.CONSOLE);
    }
    ...
    if (config[IBrowserEmulatorConfig_1.InjectedScript.NAVIGATOR]) {
        ...
        domOverrides.registerWorkerOverrides(IBrowserEmulatorConfig_1.InjectedScript.NAVIGATOR);
    }
    if (config[IBrowserEmulatorConfig_1.InjectedScript.NAVIGATOR_DEVICE_MEMORY]) {
        ...
        domOverrides.registerWorkerOverrides(IBrowserEmulatorConfig_1.InjectedScript.NAVIGATOR_DEVICE_MEMORY);
    }
    ...
    if (config[IBrowserEmulatorConfig_1.InjectedScript.WEBGL_RENDERING_CONTEXT_PROTOTYPE_GETPARAMETERS]) {
        ...
        domOverrides.registerWorkerOverrides(IBrowserEmulatorConfig_1.InjectedScript.WEBGL_RENDERING_CONTEXT_PROTOTYPE_GETPARAMETERS);
    }
    return domOverrides;
}
