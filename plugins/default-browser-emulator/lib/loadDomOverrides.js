...
function loadDomOverrides(emulationProfile, data, userAgentData) {
    ...
    domOverrides.registerWorkerOverrides('console.debug', 'navigator.deviceMemory', 'navigator.hardwareConcurrency', 'navigator', 'WebGLRenderingContext.prototype.getParameter');
    return domOverrides;
}
