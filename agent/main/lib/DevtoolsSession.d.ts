...
export default class DevtoolsSession extends TypedEventEmitter<DevtoolsEvents> implements IDevtoolsSession {
    ...
    send<T extends keyof ProtocolMapping.Commands>(method: T, params?: ProtocolMapping.Commands[T]['paramsType'][0], sendInitiator?: object): Promise<ProtocolMapping.Commands[T]['returnType']>;
