    ...
    describe('screenshots', () => {
        it('should be able to take a viewport screenshot', async () => {
         ...
         <div style="height: 200px; width: 100px; background:red">&nbsp;</div>`);
            ...
            expect(screenshot.toString('base64')).toContain('iVBORw0KGgoAAAANSUhEUgAABAAAAAOECAYAAAA/m0PDAAAAAXNSR0IArs4c6QAAFjhJREFUeJzt2rENw0AMBEG9of5bpkuQEulh70zM4OIF18zMAQAAAPy1z+4BAAAAwPMEAAAAAAgQAAAAACBAAAAAAIAA');
        });
        ...
        it('should be able to take a clipped rect screenshot', async () => {
         ...
         <div style="height: 200px; width: 100px; background:red">&nbsp;</div>`);
            ...
            expect(screenshot.toString('base64')).toContain('iVBORw0KGgoAAAANSUhEUgAAAfQAAAH0CAYAAADL1t+KAAAAAXNSR0IArs4c6QAAB');
        });
