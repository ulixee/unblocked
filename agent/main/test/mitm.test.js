...
function mitmCalls(expectedCalls) {
    ...
    const hasCalledFavicon = mocks.MitmRequestContext.create.mock.results.some(result => result.value.url.href.includes('favicon'));
    if (hasCalledFavicon) {
